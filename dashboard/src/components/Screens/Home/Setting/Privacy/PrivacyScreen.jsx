...
const PrivacyScreen = ({
  ...
  const isValueChanged =
    handleValue?.privacyPolicy.trim("") !== originalValue?.trim("");
        ...
        <Row>
          <Col xl={12}>
            <Card className="card custom-card">
              <Card.Header>
                <Card.Title className="">Privacy Policy Editor</Card.Title>
              </Card.Header>
              {getLoader || updateLoader ? (
                ...
                <Card.Body>
                  <QuillEditor
                    ...
                    onChange={(value) =>
                      handleChange({ target: { name: "privacyPolicy", value } })
                    }
                    value={handleValue.privacyPolicy}
                  />
